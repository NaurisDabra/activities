 ...
 * @author John Doe
 * 
 *         This class represents a stack structure (Last-In, First-Out)
 *         implemented using an array
 */
public class ArrayStack {

	// IMPORTANT:
	// In each of the TODOs below, the array of Objects called 'stack' will be
	// available and
	// already initialized. The integer 'count' is also available and is meant
	// to track how
	...
	/**
	 * Create an instance of an ArrayStack. A negative number specified in the
	 * constructor will default the maximum to 1
	 * 
	 * @param maximum
	...
	public ArrayStack(int maximum) {
		...
		// array of objects with a maximum length specified by the parameter
		// 'maximum'
	...
	public Object peek() {
		...
		// TODO #4: Write decision making code to see if the value of 'count' is
		// 0.
	...
	public boolean push(Object element) {
		...
		// space in the array to store one more 'element'. If there is no more
		// space,
		// return false
		...
		// TODO #7: Write code that will add the Object parameter 'element' to
		// the next
		// available index of the array. The integer variable 'count' should be
		// increased
	...
	public Object pop() {
		...
		// TODO #8: Write code that will check if there are any elements
		// contained in
		...
		// TODO #9: Write code that will subtract 1 from the variable 'count' to
		// represent an
		// element being 'removed' from the array
		count -= 1;
		// END TODO 9

		// TODO #10: Write code that will get the last element added in the
		// array and assign it
	...
	/**
	 * Returns the position of the first element found in the stack (using the
	 * == criterion) relative to the top of the stack. The top of the stack will
	 * be position 0
	 * 
	 * @param element
	 *            The element to find
	...
	public int findElement(Object element) {
		// TODO #11:
		// Create code that will search the stack array for the Object element
		// that
		// is specified in the parameter and return its position relative to the
		// end
		// of the array.
